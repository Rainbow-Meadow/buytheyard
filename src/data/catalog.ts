...
export const MULCH: CatalogItem[] = [
  ...
  { name: "Red Cedar Mulch", description: "Naturally aromatic cedar with a warm red tone. Repels insects without dye.", price: "$42.00", unit: "per yd", image: largePileOfRedMulch },
  { name: "Hemlock Mix", description: "Premium hemlock blend with a fine texture and a rich, natural brown.", price: "$42.00", unit: "per yd", image: dumpTruckBedFullOfBrownMulch },
  { name: "Playground Mulch", description: "Engineered wood fiber. ASTM-tested for fall-zone safety under play sets.", price: "$45.00", unit: "per yd", image: wheelbarrowLoadedWithDarkMulch },
];

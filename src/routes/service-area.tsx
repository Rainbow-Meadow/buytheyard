...
function ServiceAreaPage() {
  ...
  const helperBlocks: TileBlock[] = [
    {
      ...
      body: "We deliver throughout Worcester County and parts of Middlesex County. Call us and we'll confirm your ZIP and the final price before we load.",
      size: "md",
      tone: "kraft",
    },
    {
  ...
  const footerBlocks: TileBlock[] = [
    ...
    },
    {
      ...
      body: "Prefer to type it out? Send a list. We'll come back with pricing and a window.",

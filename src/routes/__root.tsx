...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Buy The Yard — Mulch, Stone, Sand & Loam · Jefferson, MA" },
      { name: "twitter:description", content: "Woman-owned materials yard on 122A in Jefferson, MA. Mulch, stone, sand, loam, and a garden center. Central Mass since 2016." },
    ],
    scripts: [
      {

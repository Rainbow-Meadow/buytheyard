    ...
    <footer className="bg-surface text-kraft border-t border-white/10">
      <div className="border-l-[1.5px] border-brand">
        <div className="max-w-7xl mx-auto px-5 md:px-8 py-10 md:py-14">
          ...
          {/* Legal bar */}
          <div className="mt-12 pt-6 border-t border-white/5 grid grid-cols-1 md:grid-cols-2 gap-y-3 items-center micro text-kraft/40 text-center md:text-left">
            <span>
              &copy; {year} Buy The Yard Material · Jefferson, MA · WBE Certified
            </span>
            <span className="flex items-center justify-center md:justify-end gap-4 text-kraft/30">
              <button
                type="button"

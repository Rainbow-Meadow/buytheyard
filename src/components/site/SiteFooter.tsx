...
export function SiteFooter() {
  return (
    <footer className="bg-surface text-surface-foreground">
      <div className="max-w-7xl mx-auto px-5 md:px-6 section grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-12 text-center md:text-left">
        ...
        <div className="md:col-span-4 flex flex-col md:flex-row items-center gap-3 md:gap-8 text-center md:text-left">

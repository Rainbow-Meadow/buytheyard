...
export function GalleryMarqueeSection({
  ...
  return (
    <Section title={title} tone="paper">
      <div className="marquee-mask overflow-hidden py-10 md:py-14 min-h-[45svh] md:min-h-[55svh] flex items-center">
        <div
        ...
        >
          {loop.map((item, i) => (
            <figure
              ...
              className="flex-shrink-0 h-56 md:h-80 aspect-[4/3] bg-soft relative overflow-hidden"
            >
              {item.src ? (
                <img
                  src={item.src}
